...
function custom_scripts() {
    ...
    wp_enqueue_script( 'template-script', get_template_directory_uri() . '/js/jquery.loadTemplate.js', array(), '', true);
...
/**
 * Load widget-filter file.
 */
require get_template_directory() . '/widget/widget-filter.php';
/**
 * Load widget-content file.
 */
require get_template_directory() . '/widget/filter-widget-content.php';
/**
 * Load taxonmy files.
 */
 ...
 * Load post-type file.
 */
require get_template_directory(). '/post-type/smartphones.pt.php';
/**
 * Load ajax_url variable.
 */
