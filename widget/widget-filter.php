...

{
	...
	public function form( $instance ) 
	{
		...
		foreach( $taxonomeis as $taxonomy ):?>
			<p>
				<input id="<?php echo $this->get_field_id($taxonomy->name); ?>" name="<?php echo $this->get_field_name($taxonomy->name); ?>" type="checkbox"<?php checked( ! empty( $instance[$taxonomy->name] ) ); ?> />&nbsp;<label for="<?php echo $this->get_field_id($taxonomy->name); ?>"><?php echo $taxonomy->labels->name;?></label>
			</p>
		<?php endforeach;?>
